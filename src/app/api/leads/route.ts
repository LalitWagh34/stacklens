...
export async function POST(req: NextRequest) {
  try {
    ...
    const { auditId, email, company, role, website } = body
    ...
    const emailResult = await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px;">
          ...
          <p style="color: #334155;">View your full audit report:</p>
          ...
          <div style="margin-top: 32px; padding: 20px; border: 1px solid #10b981; border-radius: 8px;">
            ...
            <p style="color: #64748b; margin: 0 0 12px 0;">Buy discounted AI credits for Claude, ChatGPT & more — up to 30% off retail.</p>
